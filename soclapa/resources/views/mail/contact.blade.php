            ...
            <div class="row">
                <div class="col-12">
                    <div class="contact-form-area">
                        <form action="{{url('/kontakti/send')}}" method="post">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6">
                                    <input type="email" name="email" class="form-control" id="email" placeholder="E-pasts"/>
                                </div>
                                <div class="col-12">
                                    <input type="text" name="theme" 
                                     class="form-control" id="subject" placeholder="Tēma"/>
                                </div>
                                <div class="col-12">
                                    <textarea name="message" class="form-control" id="message" cols="30" rows="10" placeholder="Ziņa"></textarea>
                                </div>
                                <div class="col-12 text-center">
                                    <button class="btn delicious-btn mt-30" type="submit" name="send" value="Send">
                                        Sūtīt
                                    </button>
                                </div>
                            </div>
