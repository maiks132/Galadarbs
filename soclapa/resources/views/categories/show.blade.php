...
@section('content')
 <!-- ##### Breadcumb Area Start ##### -->
    ...
    <div class="breadcumb-area bg-img bg-overlay" style="background-image: url(/storage/categorie_image/{{$nosaukumi->categorie_image}});">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-text text-center">
             
                        <h2>{{$nosaukumi->title}}</h2>
                    ...
                    <div class="blog-posts-area">
                        @if(count($recipes)>0)
                            @foreach($recipes as $recipe)
                                ...
                                <!-- <a href="/recipes/{{$recipe->id}}" class="btn delicious-btn mt-30">Lasīt vairāk</a> -->
                                    </div>
                                </div>
                            @endforeach
